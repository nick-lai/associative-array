...
class AssociativeArrayTest extends TestCase
{
    ...
    public function testInnerJoin()
    {
        ...
        $this->assertEquals([
            1001 => ['id' => 1001, 'category' => 'C', 'price' => 30, 'desc' => 'C desc'],
            1002 => ['id' => 1002, 'category' => 'A', 'price' => 25, 'desc' => 'A desc'],
            1003 => ['id' => 1003, 'category' => 'B', 'price' => 10, 'desc' => 'B desc'],
    ...
    public function testLeftJoin()
    {
        ...
        $this->assertEquals([
            ...
            1002 => ['id' => 1002, 'category' => 'A', 'price' => 25, 'desc' => 'A desc'],
            1003 => ['id' => 1003, 'category' => 'B', 'price' => 10, 'desc' => 'B desc'],
            1004 => ['id' => 1004, 'category' => 'X', 'price' => 60, 'desc' => null],
    ...
    public function testRightJoin()
    {
        ...
        $this->assertEquals([
            'A' => ['category' => 'A', 'desc' => 'A desc', 'id' => 1002, 'price' => 25],
            'B' => ['category' => 'B', 'desc' => 'B desc', 'id' => 1003, 'price' => 10],
            'C' => ['category' => 'C', 'desc' => 'C desc', 'id' => 1001, 'price' => 30],
            'D' => ['category' => 'D', 'desc' => 'D desc', 'id' => null, 'price' => null],
    ...
    {
        $associativeArray = new AssociativeArray([
            1001 => ['id' => 1001, 'category' => 'C', 'price' => 10],
            1002 => ['id' => 1002, 'category' => 'A', 'price' => 25],
            1003 => ['id' => 1003, 'category' => 'B', 'price' => 10],
            1004 => ['id' => 1004, 'category' => 'C', 'price' => 10],
        ]);
